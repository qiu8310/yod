  ...
  it('throws', function() {
    ...
    context('parse error check', function() {
      it('recycle depend', function() {
        (function() {yod({a: '@Self.b', b: '@Self.a' })}).should.throw(/Recycle depends found/);
        (function() {yod({a: '@Self.b.c', b: {c: '@Parent.a'} })}).should.throw(/Recycle depends found/);
      });

      it('depend on parent', function() {
        (function() {yod({a: {b: '@Parent.a'}})}).should.throw(/depend on it.s direct parent node/);
        (function() {yod({a: {b: {c: '@Parent.Parent.a'}}})}).should.throw(/depend on it.s direct parent node/);
      });

      it('not object', function() {
        (function() {yod('@Parent.a')}).should.throw(/not a object/);
        (function() {yod('@Self.a')}).should.throw(/not a object/);
      });

      it('no parent', function() {
        (function() {yod({a: '@Parent.b'})}).should.throw(/Not found parent for/);
        (function() {yod({a: {b: '@Parent.Parent.b'}})}).should.throw(/Not found parent for/);
      });

      it('object key duplicated', function() {
        (function() {yod({a: 'c', c: 't', '@Self.a': 'x'})}).should.throw(/duplicated/);
      });

      it('not found depend on', function() {
        (function() {yod({a: 'a', b: '@Self()'})}).should.throw(/resolved error/);
        (function() {yod({a: 'a', b: '@Parent()'})}).should.throw(/resolved error/);
        (function() {yod({a: 'a', b: '@Self.c'})}).should.throw(/resolved error/);
      });
    });
